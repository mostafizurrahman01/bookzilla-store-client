        ...
        <div className="container">
            ...
            <div className="Login-Register">
                ...
                <div className="Another-auth">
                    {/* <p>                           Or                          </p> */}
                    <button onClick={handleGoogleSignIn} className="btn-modify3"> <FontAwesomeIcon icon={faGoogle} size="2x" className="icon-size" /><span className="btn-text">Continue with Google</span> </button>
                    <br />
                    <button onClick={handleFbSignIn} className="btn-modify4"> <FontAwesomeIcon icon={faFacebook} size="2x" className="icon-size2" /><span className="btn-text">Continue with Facebook </span></button>
